...
GENESIS_COINS=100000000000000000000ubtsg
...
sed -i 's/enabled-unsafe-cors = false/enabled-unsafe-cors = true/g' $CHAIN_DIR/$CHAIN_ID/config/app.toml
sed -i 's#cors_allowed_origins = []#cors_allowed_origins = ["*"]#g' $CHAIN_DIR/$CHAIN_ID/config/config.toml
